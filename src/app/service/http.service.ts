...
export class HttpService {
  ...
  public get(url: string, paramMap?: any): Observable<object> {
    return this.http.get(this.URL + url, { params: HttpService.buildURLSearchParams(paramMap) });
  }

  public post(url: string, paramMap: any = null, options?: any): Observable<object> {
    return this.http.post(this.URL + url, HttpService.buildURLSearchParams(paramMap), options);
  }
  ...
  public postFormData(url: string, paramMap?: any): Observable<object> {
    ...
    return this.http.post(this.URL + url, HttpService.buildURLSearchParams(paramMap), { headers: headers });
  }
}
